...
class ModelService:
    ...
    def load_demographics(self):
        ...
        try:
            ...
            logger.info(f"Demographics data loaded successfully. Shape: {self.demographics_data.shape}")
    ...
    def enrich_with_demographics(self, zipcode: str) -> Dict:
        ...
        try:
            ...
            demographics = self.demographics_data[self.demographics_data['zipcode'] == zipcode_str]
    ...
    def prepare_features(self, request_data: Dict, minimal: bool = False) -> pd.DataFrame:
        """Prepare features for model prediction"""
        try:
            if minimal:
                ...
                features_dict = {feature: request_data.get(feature, 0.0) for feature in self.features}
